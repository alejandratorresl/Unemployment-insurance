...
quietly infix                  ///
  ...
  int     occ         105-108  ///
  int     ind         109-112  ///
  byte    classwkr    113-114  ///
  byte    whyunemp    115-115  ///
  int     educ        116-118  ///
  byte    educ99      119-120  ///
  byte    edcyc       121-122  ///
  byte    eddipged    123-124  ///
  byte    edhgcged    125-126  ///
  byte    schlcoll    127-127  ///
  int     occly       128-131  ///
  int     indly       132-135  ///
  byte    classwly    136-137  ///
  byte    workly      138-139  ///
  byte    wkswork1    140-141  ///
  byte    wkswork2    142-142  ///
  int     uhrsworkly  143-145  ///
  byte    wksunem1    146-147  ///
  byte    wksunem2    148-148  ///
  byte    fullpart    149-149  ///
  int     wkxpns      150-153  ///
  byte    pension     154-154  ///
  byte    firmsize    155-155  ///
  byte    whyptly     156-156  ///
  byte    payifabs    157-157  ///
  byte    numemps     158-158  ///
  double  inctot      159-167  ///
  double  incwage     168-175  ///
  long    incss       176-181  ///
  long    incwelfr    182-187  ///
  double  incretir    188-195  ///
  long    incunemp    196-201  ///
  long    incwkcom    202-207  ///
  long    incvet      208-214  ///
  long    incsurv     215-221  ///
  long    incdisab    222-228  ///
  long    incpens     229-235  ///
  byte    srcsurv1    236-237  ///
  byte    srcsurv2    238-239  ///
  double  incsurv1    240-247  ///
  double  incsurv2    248-255  ///
  byte    srcdisa1    256-257  ///
  byte    srcdisa2    258-259  ///
  long    incdisa1    260-266  ///
  long    incdisa2    267-273  ///
  byte    srcret1     274-275  ///
  byte    srcret2     276-277  ///
  long    incret1     278-284  ///
  long    incret2     285-291  ///
  byte    srcpen1     292-293  ///
  byte    srcpen2     294-295  ///
  long    incpen1     296-302  ///
  long    incpen2     303-309  ///
  long    retcont     310-315  ///
  byte    srcunemp    316-316  ///
  byte    srcwkcom    317-317  ///
  byte    paidgh      318-319  ///
  byte    vetlast     320-321  ///
  byte    union       322-322  ///
  using `"cps_00007.dat"'
...
label define edcyc_lbl 04 `"The third of junior year"', add
...
save "C:\Users\MTORRESLEON\Dropbox\Alejandra_RA\Unemployment insurance\Data\Clean data\insurance_ipums_v1.dta", replace
